...
public class HidePlayerList {
    ...
    public HidePlayerList() {
        this.overrideListener = new PacketAdapter(BlockCityTycoonGlobal.getPlugin(), ListenerPriority.NORMAL, PacketType.Play.Server.PLAYER_INFO) {
            @Override
            public void onPacketSending(PacketEvent event) {
                ...
                if (hiddenPlayers.contains(name)) {
                    ...
                    }.runTaskLater(BlockCityTycoonGlobal.getPlugin(), 10);
                }
            }
        };
